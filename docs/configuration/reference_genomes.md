# NF-bcl2fastq: Reference Genomes Configuration

The NF-bcl2fastq pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```groovy
includeConfig '/path/to/NF-bcl2fastq/conf/igenomes.config'
```
