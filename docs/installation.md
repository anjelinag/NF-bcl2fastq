# NF-bcl2fastq Installation

To start using the NF-bcl2fastq pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `gnetsanet/NF-bcl2fastq` is specified as the pipeline name.
...
```bash
wget https://github.com/gnetsanet/NF-bcl2fastq/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/nf-bcl2fastq-master
```
