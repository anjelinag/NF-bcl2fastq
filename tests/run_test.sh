...
data_dir=${data_path}/nf-bcl2fastq_test_set
...
then
    ...
    curl https://your_website.com/nf-bcl2fastq_test_set.tar.bz2 > ${data_path}/nf-bcl2fastq_test_set.tar.bz2
    echo "Unpacking test set..."
    tar xvjf ${data_path}/nf-bcl2fastq_test_set.tar.bz2 -C ${data_path}
    echo "Done"
fi

# Run name
run_name="Test NF-bcl2fastq Run: "$(date +%s)
